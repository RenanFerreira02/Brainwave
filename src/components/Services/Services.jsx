import { check, service1, service2, service3 } from "src/assets";
import Heading from "../Heading/Heading";
import Section from "../Section/Section";
import { brainwaveServices, brainwaveServicesIcons } from "src/constants";
      ...
      <div className="container">
        ...
        <div className="relative">
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                ...
                <p className="body-2 mb-[3rem] text-n-3">
                  Automatically enhance your photos using AI app&apos;s photo editing feature. Try it now!
                </p>
              </div>
            ...
            <div className="p-4 bg-n-7 rounded-xl overflow-hidden lg:min-h-[46rem]">
