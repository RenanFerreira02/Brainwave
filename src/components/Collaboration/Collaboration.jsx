    ...
    <Section crosses>
      <div className="container lg:flex">
        <div className="max-w-[25rem]">
          <h2 className="h2 mb-4 md:mb-8">AI Chat for seamless corporation</h2>

          <ul className="max-w-[22rem] mb-10 md:mb-14">
            {collabContent.map((content) => (
              <li className="mb-3 py-3" key={content.key}>
                ...
                {content.text && <p className="body-2 mt-3 text-n-4">{content.text}</p>}
              </li>
            ))}
          </ul>
